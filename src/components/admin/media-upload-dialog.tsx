      ...
      <DialogContent className="border-white/10 bg-zinc-950 text-zinc-100 sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription className="text-zinc-500">
            O arquivo será armazenado no OneDrive e ficará disponível para uso
            no portfólio.
          </DialogDescription>
        </DialogHeader>
        ...
        <form action={action} className="space-y-5 pt-2">
          {state.error ? (
            <div
              role="alert"
              className="flex items-start gap-3 rounded-lg border border-red-500/20 bg-red-500/10 px-3 py-2.5 text-sm text-red-300"
            >
