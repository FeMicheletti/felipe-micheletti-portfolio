						...
						<div className="space-y-3">
							...
							<div className="grid gap-2 sm:grid-cols-2">
								{mediaAssets.map((asset) => {
									...
									return (
										<label key={asset.id} className="flex cursor-pointer items-center gap-3 rounded-lg border border-white/5 bg-zinc-950/30 px-3 py-2.5 text-sm text-zinc-300 transition-colors hover:border-violet-500/20 hover:bg-violet-500/5 has-disabled:cursor-not-allowed has-disabled:opacity-50">
											<input
												type="checkbox"
												checked={selected}
												disabled={isCover}
							...
							{gallery.length ? (
								<div className="space-y-3">
									{gallery.map((item, index) => {
										...
										return (
											<div key={item.mediaId} className="grid gap-3 rounded-xl border border-white/5 bg-white/2.5 p-3 sm:grid-cols-[8rem_minmax(0,1fr)]">
