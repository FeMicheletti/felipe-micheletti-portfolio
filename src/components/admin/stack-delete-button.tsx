...
export function StackDeleteButton({
  id,
  name,
  type,
  blocked,
  ...
  const action =
    type === "category"
      ...
      : deleteTechnologyAction.bind(null, id);
    ...
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button
          ...
          title={
            blocked
              ? `Remova os vínculos com ${dependency} antes de excluir.`
              : undefined
          }
      ...
      <AlertDialogContent className="border-white/10 bg-zinc-950 text-zinc-100">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-zinc-400">
            “{name}” será excluído definitivamente. Essa ação não poderá ser
            desfeita.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
