    ...
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button
          variant="ghost"
          size="icon-sm"
          className="text-zinc-500 hover:bg-amber-500/10 hover:text-amber-300"
        >
          <Archive />
      ...
      <AlertDialogContent className="border-white/10 bg-zinc-950 text-zinc-100">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-zinc-400">
            “{title}” deixará de aparecer como publicado e não poderá permanecer
            em destaque. Você poderá reativá-lo pela edição.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
