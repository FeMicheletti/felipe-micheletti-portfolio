import { Activity, ArrowUpRight, BriefcaseBusiness, CheckCircle2, CircleDot, Layers3, MousePointerClick, Sparkles } from "lucide-react";
			...
			<section className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
				<div>
					...
					<p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-400">
						Acompanhe o conteúdo e, nas próximas etapas, as interações de quem visita seu trabalho.
					</p>
				</div>
