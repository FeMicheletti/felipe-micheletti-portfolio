...
import {
  ...
  toggleTechnologyVisibilityAction,
} from "./actions";
    ...
    <div className="space-y-6">
      <section>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-400">
          Organize categorias e tecnologias em português e inglês antes de
          vinculá-las aos projetos.
        </p>
      </section>
      ...
      <section className="grid gap-3 sm:grid-cols-3">
        {[
          ...
          <Card
            key={item.label}
            className="border-violet-500/10 bg-zinc-900/70 py-4 ring-0"
          >
            <CardContent>
        ...
        <Card className="border-violet-500/10 bg-zinc-900/70 ring-0">
          ...
          <CardContent>
            {categories.length ? (
              ...
              <p className="rounded-lg border border-dashed border-violet-500/20 p-6 text-center text-sm text-zinc-500">
                Crie a primeira categoria antes de cadastrar tecnologias.
              </p>
            )}
          </CardContent>
        </Card>
                      ...
                      <div key={technology.id} className="p-4">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                          ...
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <form
                              action={toggleTechnologyVisibilityAction.bind(
                                null,
                                technology.id,
                                !technology.visible,
                              )}
