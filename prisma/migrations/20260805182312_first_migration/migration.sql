...
CREATE TABLE `AnalyticsEvent` (
    `id` VARCHAR(191) NOT NULL,
    `eventType` ENUM('PAGE_VIEW', 'RESUME_DOWNLOAD', 'PROJECT_VIEW', 'PROJECT_DEMO_CLICK', 'PROJECT_GITHUB_CLICK', 'GITHUB_CLICK', 'LINKEDIN_CLICK', 'EMAIL_CLICK', 'LANGUAGE_CHANGE') NOT NULL,
